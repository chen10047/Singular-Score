...
from NB201.xautodl.models.cell_searchs.genotypes import get_combination
...
class TopologyStructure:
            ...
            for op, xin in node_info:
                if consider_zero is None:
                    ...
                    if op == "skip_connect":
                        ...
                        x = "(" + nodes[xin] + ")" + "@{:}".format(op)
                cur_node.append(x)
            # nodes[2] = '(0)@skip_connect+(1)@max_pool'
    ...
    @staticmethod
    def gen_all(search_space, num, return_ori=False):
        ...
        # search_space=[op1, op2]
        all_archs = get_combination(search_space, 1)
        for i, arch in enumerate(all_archs):
            all_archs[i] = [tuple(arch)]  # [[(op1,)], [(op2,)]]
