## Overview
This material contains the implementation of our proposed zero-cost proxy for neural architecture search (NAS).

For search spaces,  data and benchmarks are available from the following sources:
...
### Our Proposed Method
- File: ZeroShotProxy/compute_singular_score.py
